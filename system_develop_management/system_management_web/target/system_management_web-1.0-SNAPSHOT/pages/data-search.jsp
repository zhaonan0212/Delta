            ...
            <div class="box box-primary">
                ...
                <div class="box-footer">
                    ...
                    <div class="box-tools pull-right">
                        ...
                        ===========--%>
                        <ul class="pagination">
                            <li><a href="/data_dic/searchByName?page=1&size=${pageInfo.pageSize}&xname=${pageInfo.params}"
                                   aria-label="Previous">首页</a></li>
                            <li><a href="/data_dic/searchByName?page=${pageInfo.pageNum-1}&size=${pageInfo.pageSize}&xname=${pageInfo.params}">上一页</a>
                            </li>
                            <%--中间页--%>
                            ...
                            <c:forEach var="i" begin="${begin}" end="${end}">
                                ...
                                <c:choose>
                                    ...
                                    <c:otherwise>
                                        ...
                                        <li><a href="/data_dic/searchByName?page=${i}&size=${pageInfo.pageSize}&xname=${pageInfo.params}">${i}</a></li>
                            ...
                            <li><a href="/data_dic/searchByName?page=${pageInfo.pageNum+1}&size=${pageInfo.pageSize}&xname=${pageInfo.params}">下一页</a>
                            </li>
                            <li><a href="/data_dic/searchByName?page=${pageInfo.pages}&size=${pageInfo.pageSize}&xname=${pageInfo.params}"
                                   aria-label="Next">尾页</a></li>
...
<script>
    ...
    function changeSize(option) {
        ...
        location.href = "/data_dic/searchByName?size=" + page+"&xname=${pageInfo.params}";
